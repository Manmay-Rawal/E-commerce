      ...
      <div className="pt-6">
        ...
        <section className=" grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          <div className="flex flex-col items-center ">
            <div className="overflow-hidden rounded-lg max-w-[15rem] lg:max-w-[20rem]">
              <img
            ...
            <div className="flex flex-wrap space-x-5 justify-center">
              {product.images.map((items) => (
                <div className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-w-[4rem] max-h-[4rem] mt-4">
                  <img
                    alt={items.alt}
                    src={items.src}
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <form className="mt-10">
                ...
                <div className="mt-10">
                  ...
                  <fieldset aria-label="Choose a size" className="mt-2">
                    <RadioGroup
                      ...
                      className="grid grid-cols-5 sm:grid-cols-8 lg:grid-cols-10"
                    >
                      {product.sizes.map((size) => (
                        <Radio
                          ...
                          className={classNames(
                            ...
                            "group relative flex items-center justify-center rounded-full border w-10 h-10 text-xs font-medium uppercase hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                          )}
                        >
                          <span>{size.name}</span>
                          {size.inStock ? (
                            <span
                              aria-hidden="true"
                              className="pointer-events-none absolute -inset-px rounded-full border-2 border-transparent group-data-checked:border-indigo-500 group-data-focus:border-indigo-500"
                            />
                          ) : (
                            <span
                              aria-hidden="true"
                ...
                onClick={handleAddToCart}
                  variant="contained"
                  sx={{ marginTop: "2rem", backgroundColor: "#4F46E5" }}
                >
                  Add to Cart
                </Button>
              </form>
